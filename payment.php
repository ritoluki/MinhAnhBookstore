        ...
        <div class="product-list">
            ...
            foreach ($tensach as $index => $name) {
                ...
                if ($sach) { // Kiểm tra xem $sach có khác null không
                    $tongCong += htmlspecialchars($soluong[$index])*htmlspecialchars($sach->giaban);
            ?>
                <div class="product">
                    ...
                    <div class="product-details">
                        ...
                        <p class="product-price">Tổng: <?php echo number_format(htmlspecialchars($soluong[$index])*htmlspecialchars($sach->giaban), 0, ',', '.') . ' VNĐ'; ?></p>
                    </div>
                </div>
            <?php
                }
